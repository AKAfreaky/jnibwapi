...
public class ProductionManager extends Manager {
	...
	public ProductionManager(JNIBWAPI bwapi, ResourceManager resourceManager,
	...
	/** Returns the number of Larvae currently available to spawn into something useful */
	...
	public void gameUpdate(){
		// Update the resource manager with the number of overlords in production
