...
public class UpgradeManager extends Manager{
	...
	/** Research Zergling Speed / Metabolic Boost.
	 * Returns false if not enough resources or no spawning pool available.
	 */
	...
	/** Research Hydralisk Speed / Muscular Augments.
	 * Returns false if not enough resources or no hydralisk den available.
	 */
	 ...
	 * Returns false if not enough resources or no spire available.
	 */
	...
	/** Upgrade Zerg Melee Attack
	 * Returns false if on evo chamber, or not enough resources
	 */
